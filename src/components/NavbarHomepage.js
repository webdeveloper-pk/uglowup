  ...
  return (
    <div>
      <div className="hero-bg">
                    ...
                    <li>
                      <a href="#/">
                        <div className="btn-test from-bottom">
                          {selectedOption === "eng" ? "About" : "À propos"}
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="#services">
                        <div className="btn-test from-bottom">
                          {selectedOption === "eng" ? "service" : "service"}
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="#contact">
                        <div className="btn-test from-bottom">
                          {selectedOption === "eng" ? "contact" : "contact"}
                        </div>
                      </a>
                    </li>
        ...
        <Hero selectedLanguage={selectedOption} />
      </div>
      <AllComponent selectedLanguage={selectedOption} />
    </div>
  );
};
